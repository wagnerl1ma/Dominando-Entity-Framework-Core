...
namespace DominandoEFCore_Modulo15_Dicas.Extensions
{
    public static class SnakeCaseExtensions
    {
        ...
        //UserId -> user_id //convert para minusculo e adicionando um _
        private static string ToSnakeCase(this string name) => Regex.Replace(name, @"([a-z0-9])([A-Z])", "$1_$2").ToLower();
    }
}